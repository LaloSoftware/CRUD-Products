sap.ui.define([
	"sap/ui/test/Opa5",
	"localsap/crud/products2/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("localsap.crud.products2.test.integration.arrangements.Startup", {
