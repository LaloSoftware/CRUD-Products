sap.ui.define([
	...
	return Opa5.extend("localsap.crud.products2.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["localsap/crud/products2/localService/mockserver"], function (mockserver) {
